package com.jcontinuos.gitlab.pipeline.pipeline_realese;

import com.jcontinuos.gitlab.merge_resquest.dto.ParameterMerges;
import com.jcontinuos.gitlab.pipeline.service.PipelineRealeaseService;
...
public class PipelineApi {
    ...
    public void createNewRealease(@RequestBody ParameterMerges params) throws Exception{
    ...
    private void checkParameterMerges(ParameterMerges params) {
        checkArgument(!isNullOrEmpty(params.getTargetBranch()), "O Campo Target Brand é obrigatório.");
